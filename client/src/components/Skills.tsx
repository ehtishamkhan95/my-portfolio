  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto w-full">
            ...
            {mernSkills.map((skill, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card
                      className="p-8 h-full hover-elevate active-elevate-2 transition-all cursor-pointer overflow-visible"
                      style={{ 
                    ...
                    >
                      ...
                      >
                        <Icon className={`h-16 w-16 ${skill.color} transition-transform hover:scale-110 hover:rotate-12`} />
        ...
        <div>
          <h3 className={`text-2xl md:text-3xl font-semibold mb-8 text-center scroll-fade-in stagger-7 ${isVisible ? 'visible' : ''}`}>
            ...
            {additionalSkills.map((skill, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card
                      className="p-6 h-full hover-elevate active-elevate-2 transition-all cursor-pointer overflow-visible"
                      style={{ 
                        transformStyle: "preserve-3d",
                      }}
                    ...
                    >
                      ...
                      >
                        <Icon className={`h-12 w-12 ${skill.color} transition-transform hover:scale-110 hover:rotate-12`} />
